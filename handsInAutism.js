		...
		if(link == "choice-boards"){
			var paragraph = $("#area").html("
				...
				<ol type = "1">
					...
					<li>
						Use una de las plantillas dispuestas aqui (o crea la suya)para hacer una lista de
						opciones.					
					</li>
					<li>
		...
		if(link == "pulley-cards"){
			var paragraph = $("#area").html("
				<p>
					...
					Tienen agujeros y se est&aacuten atacados en un clip polea usable (mira el imagen).
				...
				<p>
					Una tarjeta muy com&uacuten se llama <<por favor espere>>.
					A menudo, individuos con TEA suelen interrumpir para que ganen la atenci&oacuten de sus cuidadores.
					...
					Adem&aacutes, cuando el individuo est&aacute esperando apropiadamente, elogio verbal como <<buen trabajo>> se debe proveer.
					Elogio as&iacute se debe dar de vez en cuando para animar el individuo para que siga comport&aacutendose en la misma forma.
					Tal vez ayudara seguir mostrando al individuo la tarjeta <<por favor espere>> para recordarlo que todav&iacutea est&aacute esperando.
				</p>
				<p>
					Otras tarjetas comunes son <<s&iacute>> y <<no>>. Las dos se pueden mostrar a un individuo cuando &eacutel o ella ha preguntado algo -
				...
				<ol type="1">
					<li>
						Tome fotos o corte los im&aacutegenes disponibles aqu&iacute para representar conceptos adecuados.
					</li>
					<li>
